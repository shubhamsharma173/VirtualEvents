        ...
        <Modal
              ...
              >
                ...
                <div style={maindivi}>
                  ...
                  <div style={divi}>
                  <ul style={list}>
                    <li style={listitemactive}><NavLink to="">SPONSORS</NavLink></li>
                    <li style={listitem}>FICCI EOS - JULY 2020 </li>
                    <li style={listitem}>MANUFACTURING SURVEY REPORT </li>
                    <li style={listitem}>FICCI DHRUVA SURVEY </li>
                    <li style={listitem}>WOB_FINAL REPORT_3103_V12 </li>
                    <li style={listitem}>CAPAM COMPENDIUM 2020 </li>
                    <li style={listitem}>L&T PROFILE </li>
                  </ul>
                  </div>
                </div>
                </ModalBody>
